...
public class User {
    ...
    @OneToMany(mappedBy = "user", cascade = CascadeType.ALL, orphanRemoval = true) // UserRole 클래스에 User user에 사용됨
    private Set<UserRole> userRoles = new HashSet<>(); // 겹치면 안되니까 Set
    ...
    public Set<RoleType> getRoleTypes() {
        return userRoles.stream()
                ...
                .map(Role::getName)
                .collect(Collectors.toUnmodifiableSet()); // 읽기전용 Set 으로 반환
    }
