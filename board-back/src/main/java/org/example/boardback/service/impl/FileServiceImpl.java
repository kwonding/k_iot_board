...
public class FileServiceImpl {
    ...
    /** 저장 파일명 생성 */
    private String generatedStoredName(String originalName) {
    ...
    public FileInfo saveUserProfile(MultipartFile file) {
        ...
        try {
            String original = file.getOriginalFilename(); // 프론트에서 받은 거
            String cleanName = StringUtils.cleanPath(original);
            String storedName = generatedStoredName(cleanName);
